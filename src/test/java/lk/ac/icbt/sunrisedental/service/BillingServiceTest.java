...
class BillingServiceTest {
    @Test void addsTreatmentAndConsultationFeesUsingBigDecimal() {
        ...
        }, new CatalogDao() { public Optional<Dentist> findDentist(long i) { return Optional.empty(); } public Optional<Treatment> findTreatment(long i) { return Optional.empty(); } public List<Dentist> findActiveDentists() { return List.of(); } public List<Treatment> findActiveTreatments() { return List.of(); } public Dentist saveDentist(String name) { return null; } public Treatment saveTreatment(String name, BigDecimal price) { return null; } });
